...
public:
	...
	// return the metallyness of this material
	virtual float metallyness() const { return m_metallyness; }

	//Add texture to material
	virtual void addTexture(std::string filename) { m_texture = Texture(filename); hasTexture = true; }

	virtual bool isTextured() { return hasTexture; }
